...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.manager.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.managers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text"
                       name="username" id="username" value="manager" required disabled="true" style="background-color: #fff;">
                    <div class="invalid-feedback">
                    </div>
                <span class="help-block">{{ trans('cruds.user.fields.username_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="users">{{ trans('cruds.manager.fields.user') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.manager.fields.user_helper') }}</span>
            </div>
            <div class="form-group">
